...
Skill は Claude や ChatGPT のアプリ、IDE や TUI コーディングツール、OpenClaw などの Agent Harness で使用できます。
...
- [superpowers](https://github.com/obra/superpowers/tree/main/skills)：完全なプログラミングプロジェクトワークフローをカバー
...
- [libukai](https://github.com/libukai/awesome-agent-skills/tree/main/skills)：libukai が公開した Obsidian 関連ツール Skill
- [op7418](https://github.com/op7418)：歸藏が制作した一連の Skills コレクション（PPT 作成、YouTube 分析など）
- [cclank](https://github.com/cclank/news-aggregator-skill)：指定分野の最新情報を自動収集・要約するニュース集約 Skill
- [huangserva](https://github.com/huangserva/skill-prompt-generator)：AI 人物画像テキスト生成プロンプトを生成・最適化する Skill
...
- [pua](https://github.com/tanweai/pua)：PUA スタイルで Agent をより一生懸命働かせる
- [office-hours](https://github.com/garrytan/gstack/tree/main/office-hours)：YC の視点から様々なアドバイスを提供
- [marketingskills](https://github.com/coreyhaines31/marketingskills)：マーケティング能力を強化
- [scientific-skills](https://github.com/K-Dense-AI/claude-scientific-skills)：研究者のスキルレベルを向上
