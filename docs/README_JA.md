...
-   [anthropics](https://github.com/anthropics/skills): Anthropic 公式 Skills コレクション
...
-   [op7418)](https://github.com/op7418?tab=repositories): Guizang 制作の一連の Skills コレクション。PPT 作成、YouTube 分析などを含む
-   [wshuyi](https://github.com/wshuyi/x-article-publisher-skill): Wang Shuyi の X 記事公開用 Skill
...
本プロジェクトは公式 skill-creator plugin を基に、[《Claude Skill 完全構築ガイド》](docs/Claude-Skills-完全構建指南.md)のベストプラクティスを組み込み、Agent Skills を迅速に作成・改善するための Pro 版 Plugin を構築しました。
...
`agent-skills-toolkit` プラグインを選択してインストールします。インストール完了後、会話内で使用できます。

![](../assets/media/skill-creator-pro.png)

### クイックコマンド

プラグインには強化版 skill-creator-pro skill と対応するコマンドが含まれています：
